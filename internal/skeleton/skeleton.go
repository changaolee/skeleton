...
func NewSkeletonCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Use: "skeleton",
		// 命令的简短描述
		Short: "A good Go skeleton project",
		// 命令的详细描述
...
Find more miniblog information at:
	...
	cmd.PersistentFlags().StringVarP(&cfgFile, "config", "c", "", "The path to the skeleton configuration file. Empty string for no configuration file.")
