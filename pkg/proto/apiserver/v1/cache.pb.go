...
var file_cache_proto_rawDesc = []byte{
	...
	0x2f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x61, 0x6f, 0x6c, 0x65, 0x65, 0x2f, 0x73, 0x6b, 0x65, 0x6c,
	0x65, 0x74, 0x6f, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x65,
...
func (c *cacheClient) ListSecrets(
	ctx context.Context,
...
func (c *cacheClient) ListPolicies(
	ctx context.Context,
	in *ListPoliciesRequest,
	opts ...grpc.CallOption,
...
func _Cache_ListSecrets_Handler(
	srv interface{},
	ctx context.Context,
...
func _Cache_ListPolicies_Handler(
	srv interface{},
	ctx context.Context,
	dec func(interface{}) error,
	interceptor grpc.UnaryServerInterceptor,
