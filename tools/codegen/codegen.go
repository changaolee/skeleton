...
func Usage() {
	...
	_, _ = fmt.Fprintf(os.Stderr, "\tcodegen [flags] -type T [directory]\n")
	_, _ = fmt.Fprintf(os.Stderr, "\tcodegen [flags] -type T files... # Must be a single package\n")
