...
COLOR_UNDER='\033[4m'
COLOR_ITALIC='\033[3m'
COLOR_NOITALIC='\033[23m'
COLOR_BLINK='\033[5m'
COLOR_REVERSE='\033[7m'
COLOR_CONCEAL='\033[8m'
COLOR_NOBOLD='\033[22m'
COLOR_NOUNDER='\033[24m'
...
#background color
COLOR_BBLACK='\033[40m'
COLOR_BRED='\033[41m'
COLOR_BGREEN='\033[42m'
COLOR_BYELLOW='\033[43m'
COLOR_BBLUE='\033[44m'
COLOR_BMAGENTA='\033[45m'
COLOR_BCYAN='\033[46m'
COLOR_BWHITE='\033[47m'

# Print colors you can use
skt::color::print_color() {
  echo
